...
def update_graph(selected_dates, selected_sensor):
    ...
    # Set axis labels
    fig.update_yaxes(title_text="Magnetic Field (nT)<br>with 3 Day Average", row=1, col=1)
    fig.update_yaxes(title_text="Magnetic Field (nT)<br>with Machine Learning", row=2, col=1)
    fig.update_yaxes(title_text=" Magnetic Field(nT)<br>heater effect reduced", row=3, col=1)
